...
document.getElementById("countdown").innerHTML =
  days + " days until Carla's birthday";

var confetti = {
  maxCount: 350, //set max confetti count
